...
TestObject establishPuppyHealth = new TestObject('establishPuppyHealth')
establishPuppyHealth.addProperty(
	"xpath",
	ConditionType.EQUALS,
	"//label[@for='EnsurePuppyHealth']"
)

WebUI.waitForElementClickable(establishPuppyHealth, 10)
WebUI.click(establishPuppyHealth)
...
TestObject porkOption = new TestObject('porkOption')
porkOption.addProperty(
	"xpath",
	ConditionType.EQUALS,
	"//label[@for='Pork']"
)

WebUI.waitForElementClickable(porkOption, 10)
WebUI.click(porkOption)
...
TestObject pantryFreshOption = new TestObject('pantryFreshOption')
pantryFreshOption.addProperty(
	"xpath",
	ConditionType.EQUALS,
	"//span[contains(normalize-space(.), 'Pantry Fresh')]"
)

WebUI.waitForElementClickable(pantryFreshOption, 10)
WebUI.click(pantryFreshOption)
