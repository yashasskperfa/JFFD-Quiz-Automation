...
TestObject achieveOption = new TestObject('achieveOption')
achieveOption.addProperty(
	"xpath",
	ConditionType.EQUALS,
	"//div[starts-with(normalize-space(.), 'Achieve')]"
)

WebUI.waitForElementClickable(achieveOption, 10)
WebUI.click(achieveOption)
